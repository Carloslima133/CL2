...
<body>
    <header class="container text-center">
        ...
        <p>Realizo projetos. Estudo na Angelica de oliveira
            Estou aprendendo a criar projetos no Alura , editor P5, Scratch e Git Hub . Veja os projetos
            que já desenvolvi!</p>
        <p>Meus projetos são:</p>
        <div>
            <p class="badge bg-secondary">ALURA</p>
            <p class="badge bg-secondary">EDITOR P5</p>
            <p class="badge bg-secondary">sCRATCH</p>
            <p class="badge bg-secondary">GIT HUB</p>
        </div>
    </header>
